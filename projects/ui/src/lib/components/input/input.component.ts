import {
  ...
  forwardRef,
  Host, HostBinding, Input, OnChanges, OnDestroy, OnInit,
...
export class InputComponent implements OnInit, OnChanges, AfterViewInit, DoCheck, OnDestroy, ControlValueAccessor {
  ...
  public ngOnInit(): void {
    if (this.controlContainer && this.formControlName) {
      this.control = this.controlContainer?.control?.get(this.formControlName) ? this.controlContainer?.control?.get(this.formControlName) : null
    } else {
      this.control = null;
    }
  }
